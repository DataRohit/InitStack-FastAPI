...
sed -i "s|\${POSTGRES_USERNAME}|${POSTGRES_USERNAME}|g" /tmp/metricbeat.yml
sed -i "s|\${POSTGRES_PASSWORD}|${POSTGRES_PASSWORD}|g" /tmp/metricbeat.yml
sed -i "s|\${POSTGRES_HOST}|${POSTGRES_HOST}|g" /tmp/metricbeat.yml
sed -i "s|\${POSTGRES_PORT}|${POSTGRES_PORT}|g" /tmp/metricbeat.yml
sed -i "s|\${POSTGRES_DATABASE}|${POSTGRES_DATABASE}|g" /tmp/metricbeat.yml
...
until timeout 5 bash -c "</dev/tcp/${POSTGRES_HOST}/${POSTGRES_PORT}" > /dev/null 2>&1; do
